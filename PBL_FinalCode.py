...
background_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\1.jpg")
background_img = pygame.transform.scale(background_load, (screen_width, screen_height))
menutxt_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\menu_text.png")
menutxt_img = pygame.transform.scale(menutxt_load, (2132/4, 359/4))
start_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\start.png")
start_img = pygame.transform.scale(start_load, (270*0.75, 97*0.75))
exit_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\exit.png")
exit_img = pygame.transform.scale(exit_load, (270*0.75, 97*0.75))
qbox_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\q_box.png")
qbox_img = pygame.transform.scale(qbox_load, (950*1.1, 300*1.1))
nxtsen_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\next_sentence.png")
nxtsen_img = pygame.transform.scale(nxtsen_load, (759*0.7, 76*0.7))
back_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\back.png")
back_img = pygame.transform.scale(back_load, (145*0.8, 76*0.8))
progress_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\show_progress.png")
progress_img = pygame.transform.scale(progress_load, (500, 97*0.75))
border_load = pygame.image.load(r"C:\Users\pawar\Desktop\CODE\PYTHON\VIIT\PBL\border.png")
...
def get_sentence(): #SCRAPER
    url = f"https://sentence.yourdictionary.com/a"
